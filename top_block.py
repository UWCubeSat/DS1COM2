...
# Title: Top Block
# Generated: Wed Jun 13 18:45:16 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, sps=2):
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, 'debug.txt', False)
        self.blocks_file_sink_1.set_unbuffered(True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'finaloutput.txt', False)
        ...
        self.connect((self.blocks_pdu_to_tagged_stream_0, 0), (self.digital_dxpsk_mod_0, 0))
        self.connect((self.blocks_unpacked_to_packed_xx_1, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.digital_dxpsk_demod_0, 0), (self.blocks_unpacked_to_packed_xx_1, 0))
...
def argument_parser():
    ...
    parser.add_option(
        "", "--sps", dest="sps", type="eng_float", default=eng_notation.num_to_str(2),
